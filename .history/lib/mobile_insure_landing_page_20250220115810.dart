                        ...
                        Column(
                          children: [
                            ...
                            Container(
                              color: AppColors.lightGrayishViolet,
                              width: screenWidth,
                               padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 20), // Responsive padding
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                mainAxisAlignment: MainAxisAlignment.center,
                                verticalDirection: new verticalDirection.up,
                                children: [
                                  //const SizedBox(height: 15),
                                  Center(
                                    child: Text(
                                  ...
                                  const SizedBox(height: 20),
                                  const Center(
                                    child: FittedBox(child: TextWithUrl(),),
                                  ),
                                ],
                              ),
                            ),
