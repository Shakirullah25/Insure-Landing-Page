  ...
  final List<Map<String, dynamic>> assets = [
    {
      ...
      "description":
          "Our application process can be\ncompleted in minutes, not\nhours. Don’t get stuck filling\nin tedious forms."
    },
    {
      "path": "lib/assets/image/icon-affordable-prices.svg",
      "title": "Affordable Prices",
      "description":
          "We don’t want you worrying about high\nmonthly costs. Our prices may be low, but we still offer\nthe best coverage possible."
    },
    {
      "path": "lib/assets/image/icon-people-first.svg",
      "title": "People First",
      "description":
          "Our plans aren’t full of\nconditions and clauses to prevent payouts.\nWe make sure you’re covered when\nyou need it."
    },
  ];
