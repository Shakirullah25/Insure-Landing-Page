...
import 'app_bar.dart';
import 'colors.dart';
import 'text_with_url.dart';

class DesktopInsureLandingPage extends StatefulWidget {
  const DesktopInsureLandingPage({super.key});

  @override
  _DesktopInsureLandingPageState createState() =>
      _DesktopInsureLandingPageState();
}

class _DesktopInsureLandingPageState extends State<DesktopInsureLandingPage> {
  String? activeButton;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Divider(
                              color:
                                  AppColors.darkGrayishViolet.withOpacity(0.9),
                              thickness: 1,
                            ),
                            const SizedBox(height: 40),
                            Align(
                            ...
                            Divider(
                              color:
                                  AppColors.darkGrayishViolet.withOpacity(0.95),
                              thickness: 1,
                            ),
                            const SizedBox(height: 20),
                            Center(
